...
def run(arch_enc, outputs, inc_channels, inp, n_classes, nn_epochs):
    print(arch_enc, outputs, inc_channels)
    ...
    for epoch in range(nn_epochs):
        ...
        text_time = ('Time spent on training and validation for {} epochs: {}'.format(nn_epochs, time_elapsed))
    ...
    return best_kappa, best_f1, best_epoch, str(time_elapsed), best_auroc, best_auprc, \
        best_auroc_all, best_auprc_all, best_f1_all, trainable_params